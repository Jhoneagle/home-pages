...
class TipandtrickView extends React.Component {
  render() {
	...
	<p>
	  ...
	  So yeah if your example content creator or web designer or something like that you might actually like this a lot. There is website called <div className="link"><a href="https://www.saavutettavuus.fi/kontrasti.php">saavutettavuus.fi</a></div> which contains a lot of simple stuff about accessibility and colors. 
	  
	  For example do you need to know contrast diffirent between colors or how well ou can see text from background or maybe you want to find a new color. These all can be found from th website. The website also contains lot of other stuff about accessibility too but the color part s one of the most important in the end.
